(function () {
    function ViewDispatchCtrl(EmployeeDAO, $rootScope, $stateParams, $state, $modal, Page, $debounce, PositionDAO, DispatchDAO, InsurerDAO, $timeout) {
        var ctrl = this;
...
//        ctrl.retrieveEmployees();
    ...
    ;
    angular.module('xenon.controllers').controller('ViewDispatchCtrl', ["EmployeeDAO", "$rootScope", "$stateParams", "$state", "$modal", "Page", "$debounce", "PositionDAO", "DispatchDAO", "InsurerDAO", "$timeout", ViewDispatchCtrl]);
})();