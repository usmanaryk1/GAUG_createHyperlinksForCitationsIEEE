...
//                var dashboard = this.addItem('Dashboard', '/admin/dashboard', 'fa-home');
                ...
                var benefits = this.addItem('Benefits', '/admin', 'fa-usd', 'CREATE_WORKSITE,EDIT_WORKSITE,VIEW_WORKSITE');
...
//                var security = this.addItem('Security', '/admin', 'linecons-lock');
                ...
                benefits.addItem('Add Benefit', './benefits/', 'CREATE_WORKSITE');
                benefits.addItem('View Benefit', './benefits', 'VIEW_WORKSITE');
                // Subitems of company
